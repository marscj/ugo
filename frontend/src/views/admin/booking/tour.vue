      ...
      <a-row :gutter="18">
        ...
        <a-col :span="6">
          <a-form-item class="form-item" label="Supplier">
            <a-input v-model="form.supplier" placeholder="Supplier Name"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="6">
    ...
    updateDateTime(data) {
      return {
        ...
        pick_up_time: data.pick_up_time
          ? moment(data.pick_up_time, "YYYY-MM-DD HH:mm")
          : null
      };
    },
    translateDate(data) {
      return {
        ...
        pick_up_time: data.pick_up_time ? data.pick_up_time.format("YYYY-MM-DD HH:mm") : null,
      };
    },
    fetch(id) {
      this.spinning = true;
